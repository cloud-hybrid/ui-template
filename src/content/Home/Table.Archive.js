...
const Bread = () => (<Breadcrumb Title={"/Nexus/Version-Control/Gitlab"}/>);
        ...
        <>
            ...
            <DataTable
                ...
                render={
                    ...
                    <TableContainer className={"io-primary-page-data-table-container bx--data-table-container-gitlab"} title={"Cloud-Technology"} description="Cloud-Technology's GitHub Repositories" {...getTableContainerProps()}>
                                ...
                                {Projects.map((Row, Index) => (
                                    <Fragment key={String(Index) + "-" + "DOM-Table-Fragment" + "-" + Row.UID}>
                                        <TableExpandRow expandIconDescription={"Select to Expand Repository's Description"}{...getRowProps({row: rows[Index]})}>
                                            <TableSelectRow { ...getSelectionProps({row: rows[Index]})}/>
