...
exports.EditSidePanel = EditSidePanel = _settings.pkg.checkComponentEnabled(EditSidePanel, componentName); // The display name of the component, used by React. Note that displayName
